...
<body>
    ...
    <?php
        ...
        $SELECT = "SELECT * FROM Customers WHERE c_email = '{$user}'";
    ...
    ?>
    <ul>
        <li><img src="../../Backend/storage/<?php echo $row['c_image'];?>" height="120px" width="90px"> </li>
        <li>Name: <?php echo $row['c_name'];?></li>
        <li>Email: <?php echo $row['c_email'];?></li>
        <li>Phone: <?php echo $row['c_phone'];?></li>
    </ul>
